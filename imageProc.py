...
class ImageProcessor:
	...
	def edgeDetection(self, im_url = None, e_type = 'Canny'):
		if im_url is None:
		...
		if e_type == 'Canny':
			...
			im = self.sobelEdgeDetection(im_url)
		return im

	def sobelEdgeDetection(self, im_url):
		# Code taken from https://dev.to/enzoftware/how-to-build-amazing-image-filters-with-python-median-filter---sobel-filter---5h7
